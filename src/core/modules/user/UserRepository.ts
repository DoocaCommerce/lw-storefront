...
const USER_ADDRESS_DEFAULT_FIELDS = ['id', 'receiver', 'zip_code', 'street', 'city', 'state', 'number', 'detail']

const USER_GROUP_DEFAULT_FIELDS = ['id', 'name']

const USER_IMAGE_DEFAULT_FIELDS = ['src', 'alt']
