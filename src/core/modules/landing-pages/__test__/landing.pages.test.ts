...
describe('Landing Pages Module', () => {
  it('Should get landing page by id with all fields succefully', async () => {
    const ID_FILTER = 1
    const landingPageResult: LandingPage = await LandingPagesService.getById(ID_FILTER)
  ...
  it('Should get landing page by id with selected fields succefully', async () => {
    ...
    const landingPageResult: LandingPage = await LandingPagesService.getById(ID_FILTER, SELECTED_FIELDS)
  ...
  it('Should get landing page by slug with all fields succefully', async () => {
    ...
    const landingPageResult: LandingPage = await LandingPagesService.getBySlug(SLUG_FILTER)
